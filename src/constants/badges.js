export const BADGES = [
  ...
  // BADGES POR HABILIDADE COGNITIVA
  {
    id: 'badge-analista',
  ...
  // BADGES ESPECIAIS DE PROGRESSÃO
  {
    id: 'badge-iniciante-total',
    ...
    reqQuestions: [
      ...
      'hist-q1', 'hist-001', 'hist-004',
      'bio-q1', 'bio-001', 'bio-002',
      'lin-q1', 'lin-001', 'lin-005',
      'soc-001', 'soc-005', 'soc-011',
      'fil-001', 'fil-003', 'fil-008'
    ]
  },
  {
    id: 'badge-intermediario-total',
  ...
  // BADGES TEMPORÁRIOS/EVENTOS
  {
    id: 'badge-independencia',
  ...
  {
    id: 'badge-mentor',
    name: "Mentor do Saber",
    desc: "Ajudou 10 colegas através do sistema de tutoria.",
    icon: '👨‍🏫',
    reqMentorHelp: 10
  },
  {
    id: 'badge-pergunta-boa',
    name: "Questionador Crítico",
    desc: "Teve uma pergunta sua selecionada para o banco oficial.",
    icon: '❓',
    reqQuestionSubmitted: true
  },
  {
    id: 'badge-feedback',
...
// Badges de Geogames (mantidos do original)
export const GEO_BADGES = [
