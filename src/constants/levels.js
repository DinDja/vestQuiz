...
export const getLevelData = (xp = 0) => {
  ...
  let cardStyle = "";
  if (level <= 5) cardStyle = "from-emerald-600 to-teal-800 border-emerald-400/30"; 
  else if (level <= 10) cardStyle = "from-blue-600 to-indigo-800 border-blue-400/30"; 
  else if (level <= 15) cardStyle = "from-violet-600 to-purple-900 border-purple-400/30"; 
  else cardStyle = "from-slate-900 via-slate-800 to-slate-900 border-amber-500/50 shadow-[0_0_20px_rgba(245,158,11,0.15)]";
